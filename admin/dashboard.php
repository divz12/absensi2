        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="#" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><img class="rounded-circle" src="../assets/img/logo.png" alt="" style="width: 40px; height: 40px;"></img>Absensi</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    <a href="../admin/dashboard.php" class="nav-item nav-link"><i class="fa fa-home me-2"></i>Dashboard</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-folder me-2"></i>Data Siswa</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="../admin/siswa/index.php" class="dropdown-item">Siswa</a>
                            <a href="../admin/kelas/index.php" class="dropdown-item">Kelas</a>
                            <a href="../admin/jurusan/index.php" class="dropdown-item">Jurusan</a>
                        </div>
                    </div>
                    <a href="../admin/pengajuan/index.php" class="nav-item nav-link"><i class="fa fa-file me-2"></i>Pengajuan</a>
                    <a href="../admin/absen/index.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Rekap Absen</a>
                    <a href="../admin/absen/absen-cepat.php" class="nav-item nav-link"><i class="fa fa-clock me-2"></i>Pengaturan Jam</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php echo $jumlah_siswa; ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php echo $jumlah_kelas; ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php echo $jumlah_jurusan; ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php echo $jumlah_pengajuan; ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
